...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("[&_tr]:border-b [&_tr]:border-slate-800 bg-slate-950/60", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn("bg-slate-800/50 font-medium text-slate-200", className)}
    {...props}
  />
));
